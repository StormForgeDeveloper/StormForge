...
#define MODULE_FUNCTION_DEFINED
/**
...
#if !defined(MODULE_FUNCTION_DEFINED)
...
static int xmlModulePlatformClose(void *p)
{
	return 0;
}


static int xmlModulePlatformSymbol(void *p1, const char *p2, void **p3)
{
	return 0;
}

#else
#undef MODULE_FUNCTION_DEFINED
#endif
