...
ILconst_string iluErrorStringsFrench[IL_FILE_READ_ERROR - IL_INVALID_ENUM + 1] = {
	IL_TEXT("?um?ation invalide"),
    IL_TEXT("d?assement de m?oire"),
	IL_TEXT("format non support?"),
	IL_TEXT("erreur interne"),
	IL_TEXT("valeur ill?ale"),
    IL_TEXT("op?ation ill?ale"),
	IL_TEXT("valeur de fichier ill?ale"),
	IL_TEXT("en-t?e de fichier invalide"),
	IL_TEXT("param?re invalide"),
	IL_TEXT("ne peut pas ouvrir le fichier"),
	IL_TEXT("extension invalide"),
	IL_TEXT("fichier d??existant"),
	IL_TEXT("?uivalent hors-format"),
...
ILconst_string iluLibErrorStringsFrench[IL_LIB_EXR_ERROR - IL_LIB_GIF_ERROR + 1] = {
	IL_TEXT("gif : erreur dans la librairie"),	//or: gif : erreur dans la biblioth?ue (but less used)
