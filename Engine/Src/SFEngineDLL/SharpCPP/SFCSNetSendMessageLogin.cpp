...
// Cmd: Login request
SFDLL_EXPORT int  CSSFNetAdapter_LoginLoginCmd( intptr_t InNativeConnectionHandle, const TransactionID& InTransactionID, uint32_t InGameID, const char* InID, const char* InPassword )
{
...
SFDLL_EXPORT int  CSSFNetAdapter_LoginLoginByFacebookCmd( intptr_t InNativeConnectionHandle, const TransactionID& InTransactionID, uint32_t InGameID, uint64_t InUID, const char* InFaceBookName, const char* InEMail, const char* InFacebookToken )
{
 	auto pConnection = NativeToObject<Net::Connection>(InNativeConnectionHandle);
	if(pConnection == nullptr) return (int)ResultCode::INVALID_POINTER;
...
// Cmd: Login request with Facebook UID
SFDLL_EXPORT int  CSSFNetAdapter_LoginLoginBySteamCmd( intptr_t InNativeConnectionHandle, const TransactionID& InTransactionID, uint32_t InGameID, uint64_t InSteamUserID, const char* InSteamUserName, const char* InSteamUserToken )
{
 	auto pConnection = NativeToObject<Net::Connection>(InNativeConnectionHandle);
	if(pConnection == nullptr) return (int)ResultCode::INVALID_POINTER;
...
// Cmd: Login request
SFDLL_EXPORT int  CSSFNetAdapter_LoginCreateRandomUserCmd( intptr_t InNativeConnectionHandle, const TransactionID& InTransactionID, uint32_t InGameID, const char* InCellPhone )
{
 	auto pConnection = NativeToObject<Net::Connection>(InNativeConnectionHandle);
	if(pConnection == nullptr) return (int)ResultCode::INVALID_POINTER;
...
SFDLL_EXPORT int  CSSFNetAdapter_LoginUpdateMyScoreCmd( intptr_t InNativeConnectionHandle, const TransactionID& InTransactionID, uint64_t InRankingScore, int InRankingType, uint16_t InCount )
{
 	auto pConnection = NativeToObject<Net::Connection>(InNativeConnectionHandle);
	if(pConnection == nullptr) return (int)ResultCode::INVALID_POINTER;
...
SFDLL_EXPORT int  CSSFNetAdapter_LoginGetRankingListCmd( intptr_t InNativeConnectionHandle, const TransactionID& InTransactionID, int InRankingType, uint8_t InBaseRanking, uint8_t InCount )
{
 	auto pConnection = NativeToObject<Net::Connection>(InNativeConnectionHandle);
	if(pConnection == nullptr) return (int)ResultCode::INVALID_POINTER;
...
SFDLL_EXPORT int  CSSFNetAdapter_LoginDataTestCmd( intptr_t InNativeConnectionHandle, const TransactionID& InTransactionID, uint16_t _sizeOfInTestData,const uint8_t* InTestData )
{
 	auto pConnection = NativeToObject<Net::Connection>(InNativeConnectionHandle);
	if(pConnection == nullptr) return (int)ResultCode::INVALID_POINTER;
...
SFDLL_EXPORT int  CSSFNetAdapter_LoginDebugPrintALLRankingCmd( intptr_t InNativeConnectionHandle, const TransactionID& InTransactionID, const char* InFileName )
{
 	auto pConnection = NativeToObject<Net::Connection>(InNativeConnectionHandle);
	if(pConnection == nullptr) return (int)ResultCode::INVALID_POINTER;
...
// Cmd: Login request
SFDLL_EXPORT int  CSSFNetAdapter_LoginLoginRes( intptr_t InNativeConnectionHandle, const TransactionID& InTransactionID, Result InResult, const char* InGameServerPublicAddress, AccountID InAccID, AuthTicket InTicket, uint64_t InLoginEntityUID, const char* InErrorReason )
{
 	auto pConnection = NativeToObject<Net::Connection>(InNativeConnectionHandle);
	if(pConnection == nullptr) return (int)ResultCode::INVALID_POINTER;
...
// Cmd: Login request with Facebook UID
SFDLL_EXPORT int  CSSFNetAdapter_LoginLoginByFacebookRes( intptr_t InNativeConnectionHandle, const TransactionID& InTransactionID, Result InResult, const char* InGameServerPublicAddress, AccountID InAccID, AuthTicket InTicket, uint64_t InLoginEntityUID, const char* InErrorReason )
{
 	auto pConnection = NativeToObject<Net::Connection>(InNativeConnectionHandle);
	if(pConnection == nullptr) return (int)ResultCode::INVALID_POINTER;
...
// Cmd: Login request with Facebook UID
SFDLL_EXPORT int  CSSFNetAdapter_LoginLoginBySteamRes( intptr_t InNativeConnectionHandle, const TransactionID& InTransactionID, Result InResult, const char* InGameServerPublicAddress, AccountID InAccID, AuthTicket InTicket, uint64_t InLoginEntityUID, const char* InErrorReason )
{
 	auto pConnection = NativeToObject<Net::Connection>(InNativeConnectionHandle);
	if(pConnection == nullptr) return (int)ResultCode::INVALID_POINTER;
...
// Cmd: Login request
SFDLL_EXPORT int  CSSFNetAdapter_LoginCreateRandomUserRes( intptr_t InNativeConnectionHandle, const TransactionID& InTransactionID, Result InResult, const char* InGameServerPublicAddress, AccountID InAccID, AuthTicket InTicket, uint64_t InLoginEntityUID )
{
 	auto pConnection = NativeToObject<Net::Connection>(InNativeConnectionHandle);
	if(pConnection == nullptr) return (int)ResultCode::INVALID_POINTER;
...
// Cmd: Update my score and Get Ranking list
SFDLL_EXPORT int  CSSFNetAdapter_LoginUpdateMyScoreRes( intptr_t InNativeConnectionHandle, const TransactionID& InTransactionID, Result InResult, uint16_t _sizeOfInRanking,const TotalRankingPlayerInformation* InRanking )
{
 	auto pConnection = NativeToObject<Net::Connection>(InNativeConnectionHandle);
	if(pConnection == nullptr) return (int)ResultCode::INVALID_POINTER;
...
// Cmd: Get Ranking lise
SFDLL_EXPORT int  CSSFNetAdapter_LoginGetRankingListRes( intptr_t InNativeConnectionHandle, const TransactionID& InTransactionID, Result InResult, uint16_t _sizeOfInRanking,const TotalRankingPlayerInformation* InRanking )
{
 	auto pConnection = NativeToObject<Net::Connection>(InNativeConnectionHandle);
	if(pConnection == nullptr) return (int)ResultCode::INVALID_POINTER;
...
// Cmd: For network test
SFDLL_EXPORT int  CSSFNetAdapter_LoginDataTestRes( intptr_t InNativeConnectionHandle, const TransactionID& InTransactionID, Result InResult, uint16_t _sizeOfInTestData,const uint8_t* InTestData )
{
 	auto pConnection = NativeToObject<Net::Connection>(InNativeConnectionHandle);
	if(pConnection == nullptr) return (int)ResultCode::INVALID_POINTER;
...
// Cmd: Write All!! User Score and Ranking list
SFDLL_EXPORT int  CSSFNetAdapter_LoginDebugPrintALLRankingRes( intptr_t InNativeConnectionHandle, const TransactionID& InTransactionID, Result InResult )
{
 	auto pConnection = NativeToObject<Net::Connection>(InNativeConnectionHandle);
	if(pConnection == nullptr) return (int)ResultCode::INVALID_POINTER;
