...
namespace SF
{
	...
	public:
		...
		virtual void SetVariable(const char* varName, const NamedVariable& value) override;
		...
		virtual void SetVariable(const char* varName, const Array<NamedVariable>& value) override;
