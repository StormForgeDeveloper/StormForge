...
// Select surface extension
#if SF_PLATFORM == SF_PLATFORM_WINDOWS
#define VK_USE_PLATFORM_WIN32_KHR
#define SFVK_SURFACE_EXTENSION_NAME VK_KHR_WIN32_SURFACE_EXTENSION_NAME
#elif SF_PLATFORM == SF_PLATFORM_ANDROID
#define VK_USE_PLATFORM_ANDROID_KHR
#define SFVK_SURFACE_EXTENSION_NAME VK_KHR_ANDROID_SURFACE_EXTENSION_NAME
#elif SF_PLATFORM == SF_PLATFORM_IOS
#elif SF_PLATFORM == SF_PLATFORM_LINUX
#define VK_USE_PLATFORM_XCB_KHR
#define SFVK_SURFACE_EXTENSION_NAME VK_KHR_XCB_SURFACE_EXTENSION_NAME
#endif
