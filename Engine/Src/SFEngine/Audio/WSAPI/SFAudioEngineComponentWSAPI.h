...
// Author : KyungKun Ko
//
// Description : Audio Engine component WSAPI
//	
//
////////////////////////////////////////////////////////////////////////////////
...
namespace SF
{
    class AudioDeviceWSAPI;

	/////////////////////////////////////////////////////////////////////////////////////
	// 
	//	AudioEngineCmponent
	// 
	class AudioEngineComponentWSAPI : public LibraryComponent, public AudioService
	{
	public:

		using super = LibraryComponent;

        static constexpr StringCrc64 TypeName = "AudioEngineComponentWSAPI";

	public:

        AudioEngineComponentWSAPI();
		virtual ~AudioEngineComponentWSAPI();
    ...
    private:
        ...
        // Playback device
        AudioPlaybackDeviceWSAPIPtr m_PlaybackDevice;
