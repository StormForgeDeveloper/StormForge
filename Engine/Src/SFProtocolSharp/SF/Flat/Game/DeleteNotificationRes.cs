...
public struct DeleteNotificationRes : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_7(); }
  public static DeleteNotificationRes GetRootAsDeleteNotificationRes(ByteBuffer _bb) { return GetRootAsDeleteNotificationRes(_bb, new DeleteNotificationRes()); }
  public static DeleteNotificationRes GetRootAsDeleteNotificationRes(ByteBuffer _bb, DeleteNotificationRes obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
...
static public class DeleteNotificationResVerify
{
