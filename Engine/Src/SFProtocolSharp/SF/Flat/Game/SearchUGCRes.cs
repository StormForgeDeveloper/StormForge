...
public struct SearchUGCRes : IFlatbufferObject
{
  ...
  public static Offset<SF.Flat.Game.SearchUGCRes> CreateSearchUGCRes(FlatBufferBuilder builder,
      uint result = 0) {
    builder.StartTable(1);
    SearchUGCRes.AddResult(builder, result);
    return SearchUGCRes.EndSearchUGCRes(builder);
  }

  public static void StartSearchUGCRes(FlatBufferBuilder builder) { builder.StartTable(1); }
