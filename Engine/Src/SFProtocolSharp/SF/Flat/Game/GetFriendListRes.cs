...
public struct GetFriendListRes : IFlatbufferObject
{
  ...
  public ushort MaxFriendSlot { get { int o = __p.__offset(4); return o != 0 ? __p.bb.GetUshort(o + __p.bb_pos) : (ushort)0; } }
  public ushort TotalNumberOfFriends { get { int o = __p.__offset(6); return o != 0 ? __p.bb.GetUshort(o + __p.bb_pos) : (ushort)0; } }
  public ushort StartIndex { get { int o = __p.__offset(8); return o != 0 ? __p.bb.GetUshort(o + __p.bb_pos) : (ushort)0; } }
  public SF.Flat.PlayerInformation? FriendList(int j) { int o = __p.__offset(10); return o != 0 ? (SF.Flat.PlayerInformation?)(new SF.Flat.PlayerInformation()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
  public int FriendListLength { get { int o = __p.__offset(10); return o != 0 ? __p.__vector_len(o) : 0; } }
  ...
  public static void StartGetFriendListRes(FlatBufferBuilder builder) { builder.StartTable(4); }
  public static void AddMaxFriendSlot(FlatBufferBuilder builder, ushort maxFriendSlot) { builder.AddUshort(0, maxFriendSlot, 0); }
  public static void AddTotalNumberOfFriends(FlatBufferBuilder builder, ushort totalNumberOfFriends) { builder.AddUshort(1, totalNumberOfFriends, 0); }
  public static void AddStartIndex(FlatBufferBuilder builder, ushort startIndex) { builder.AddUshort(2, startIndex, 0); }
  public static void AddFriendList(FlatBufferBuilder builder, VectorOffset friendListOffset) { builder.AddOffset(3, friendListOffset.Value, 0); }
...
static public class GetFriendListResVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      && verifier.VerifyField(tablePos, 4 /*MaxFriendSlot*/, 2 /*ushort*/, 2, false)
      && verifier.VerifyField(tablePos, 6 /*TotalNumberOfFriends*/, 2 /*ushort*/, 2, false)
      && verifier.VerifyField(tablePos, 8 /*StartIndex*/, 2 /*ushort*/, 2, false)
      && verifier.VerifyVectorOfTables(tablePos, 10 /*FriendList*/, SF.Flat.PlayerInformationVerify.Verify, false)
