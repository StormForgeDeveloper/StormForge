...
public struct GetGamePlayerInfoRes : IFlatbufferObject
{
  ...
  public static Offset<SF.Flat.Game.GetGamePlayerInfoRes> CreateGetGamePlayerInfoRes(FlatBufferBuilder builder,
      uint result = 0,
      ulong player_id = 0,
      VectorOffset attributesOffset = default(VectorOffset)) {
    builder.StartTable(3);
    GetGamePlayerInfoRes.AddPlayerId(builder, player_id);
    GetGamePlayerInfoRes.AddAttributes(builder, attributesOffset);
    GetGamePlayerInfoRes.AddResult(builder, result);
    return GetGamePlayerInfoRes.EndGetGamePlayerInfoRes(builder);
  }
