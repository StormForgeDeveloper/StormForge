...
public struct GetUGCTemplatesCmd : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_7(); }
  public static GetUGCTemplatesCmd GetRootAsGetUGCTemplatesCmd(ByteBuffer _bb) { return GetRootAsGetUGCTemplatesCmd(_bb, new GetUGCTemplatesCmd()); }
  public static GetUGCTemplatesCmd GetRootAsGetUGCTemplatesCmd(ByteBuffer _bb, GetUGCTemplatesCmd obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public GetUGCTemplatesCmd __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<SF.Flat.Game.GetUGCTemplatesCmd> CreateGetUGCTemplatesCmd(FlatBufferBuilder builder,
      VectorOffset tagsOffset = default(VectorOffset)) {
    builder.StartTable(1);
    GetUGCTemplatesCmd.AddTags(builder, tagsOffset);
    return GetUGCTemplatesCmd.EndGetUGCTemplatesCmd(builder);
  }

  public static void StartGetUGCTemplatesCmd(FlatBufferBuilder builder) { builder.StartTable(1); }
  ...
  public static Offset<SF.Flat.Game.GetUGCTemplatesCmd> EndGetUGCTemplatesCmd(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<SF.Flat.Game.GetUGCTemplatesCmd>(o);
  }
}


static public class GetUGCTemplatesCmdVerify
{
