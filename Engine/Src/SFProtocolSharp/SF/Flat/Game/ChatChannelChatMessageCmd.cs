...
public struct ChatChannelChatMessageCmd : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_7(); }
  public static ChatChannelChatMessageCmd GetRootAsChatChannelChatMessageCmd(ByteBuffer _bb) { return GetRootAsChatChannelChatMessageCmd(_bb, new ChatChannelChatMessageCmd()); }
  public static ChatChannelChatMessageCmd GetRootAsChatChannelChatMessageCmd(ByteBuffer _bb, ChatChannelChatMessageCmd obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  ...
  public static Offset<SF.Flat.Game.ChatChannelChatMessageCmd> EndChatChannelChatMessageCmd(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<SF.Flat.Game.ChatChannelChatMessageCmd>(o);
  }
}


static public class ChatChannelChatMessageCmdVerify
{
