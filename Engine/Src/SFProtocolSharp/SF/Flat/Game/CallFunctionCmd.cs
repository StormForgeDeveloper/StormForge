...
public struct CallFunctionCmd : IFlatbufferObject
{
  ...
  public byte Parameters(int j) { int o = __p.__offset(6); return o != 0 ? __p.bb.Get(__p.__vector(o) + j * 1) : (byte)0; }
  public int ParametersLength { get { int o = __p.__offset(6); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<byte> GetParametersBytes() { return __p.__vector_as_span<byte>(6, 1); }
#else
  public ArraySegment<byte>? GetParametersBytes() { return __p.__vector_as_arraysegment(6); }
#endif
  public byte[] GetParametersArray() { return __p.__vector_as_array<byte>(6); }

  public static Offset<SF.Flat.Game.CallFunctionCmd> CreateCallFunctionCmd(FlatBufferBuilder builder,
  ...
  public static void StartCallFunctionCmd(FlatBufferBuilder builder) { builder.StartTable(2); }
  ...
  public static Offset<SF.Flat.Game.CallFunctionCmd> EndCallFunctionCmd(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<SF.Flat.Game.CallFunctionCmd>(o);
  }
}
...
static public class CallFunctionCmdVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfData(tablePos, 6 /*Parameters*/, 1 /*byte*/, false)
