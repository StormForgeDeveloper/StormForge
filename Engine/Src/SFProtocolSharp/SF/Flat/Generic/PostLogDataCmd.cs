...
public struct PostLogDataCmd : IFlatbufferObject
{
  ...
  public static Offset<SF.Flat.Generic.PostLogDataCmd> CreatePostLogDataCmd(FlatBufferBuilder builder,
      StringOffset dest_log_channelOffset = default(StringOffset),
      VectorOffset message_dataOffset = default(VectorOffset)) {
    builder.StartTable(2);
    PostLogDataCmd.AddMessageData(builder, message_dataOffset);
    PostLogDataCmd.AddDestLogChannel(builder, dest_log_channelOffset);
    return PostLogDataCmd.EndPostLogDataCmd(builder);
  }

  public static void StartPostLogDataCmd(FlatBufferBuilder builder) { builder.StartTable(2); }
