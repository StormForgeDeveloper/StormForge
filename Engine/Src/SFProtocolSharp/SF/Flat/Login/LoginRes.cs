...
public struct LoginRes : IFlatbufferObject
{
  ...
  public static Offset<SF.Flat.Login.LoginRes> CreateLoginRes(FlatBufferBuilder builder,
      uint result = 0,
    ...
    LoginRes.AddAuthTicket(builder, auth_ticket);
    LoginRes.AddAccountId(builder, account_id);
    LoginRes.AddGameServerAddress(builder, game_server_addressOffset);
    LoginRes.AddBannedReason(builder, banned_reasonOffset);
    LoginRes.AddNickName(builder, nick_nameOffset);
    LoginRes.AddResult(builder, result);
    return LoginRes.EndLoginRes(builder);
  }
