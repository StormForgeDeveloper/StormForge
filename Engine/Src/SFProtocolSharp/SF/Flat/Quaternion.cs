...
public struct Quaternion : IFlatbufferObject
{
  ...
  public static Offset<SF.Flat.Quaternion> CreateQuaternion(FlatBufferBuilder builder, float X, float Y, float Z, float W) {
    builder.Prep(4, 16);
    builder.PutFloat(W);
    builder.PutFloat(Z);
    builder.PutFloat(Y);
    builder.PutFloat(X);
    return new Offset<SF.Flat.Quaternion>(builder.Offset);
  }
}
