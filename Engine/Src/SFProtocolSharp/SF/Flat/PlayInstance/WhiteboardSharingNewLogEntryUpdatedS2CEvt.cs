...
public struct WhiteboardSharingNewLogEntryUpdatedS2CEvt : IFlatbufferObject
{
  private Table __p;
  ...
  public WhiteboardSharingNewLogEntryUpdatedS2CEvt __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<SF.Flat.PlayInstance.WhiteboardSharingNewLogEntryUpdatedS2CEvt> CreateWhiteboardSharingNewLogEntryUpdatedS2CEvt(FlatBufferBuilder builder,
      ulong play_instance_uid = 0,
      ulong player_id = 0,
      VectorOffset log_entryOffset = default(VectorOffset)) {
    builder.StartTable(3);
    WhiteboardSharingNewLogEntryUpdatedS2CEvt.AddPlayerId(builder, player_id);
    WhiteboardSharingNewLogEntryUpdatedS2CEvt.AddPlayInstanceUid(builder, play_instance_uid);
    WhiteboardSharingNewLogEntryUpdatedS2CEvt.AddLogEntry(builder, log_entryOffset);
    return WhiteboardSharingNewLogEntryUpdatedS2CEvt.EndWhiteboardSharingNewLogEntryUpdatedS2CEvt(builder);
  }

  public static void StartWhiteboardSharingNewLogEntryUpdatedS2CEvt(FlatBufferBuilder builder) { builder.StartTable(3); }
  ...
  public static Offset<SF.Flat.PlayInstance.WhiteboardSharingNewLogEntryUpdatedS2CEvt> EndWhiteboardSharingNewLogEntryUpdatedS2CEvt(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<SF.Flat.PlayInstance.WhiteboardSharingNewLogEntryUpdatedS2CEvt>(o);
  }
}


static public class WhiteboardSharingNewLogEntryUpdatedS2CEvtVerify
{
