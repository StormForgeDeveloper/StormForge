...
public struct UseMapObjectRes : IFlatbufferObject
{
  ...
  public static Offset<SF.Flat.PlayInstance.UseMapObjectRes> CreateUseMapObjectRes(FlatBufferBuilder builder,
      uint result = 0,
      ulong play_instance_uid = 0,
      ulong player_id = 0,
      uint map_object_id = 0,
      VectorOffset result_attributesOffset = default(VectorOffset)) {
    builder.StartTable(5);
    UseMapObjectRes.AddPlayerId(builder, player_id);
    UseMapObjectRes.AddPlayInstanceUid(builder, play_instance_uid);
    UseMapObjectRes.AddResultAttributes(builder, result_attributesOffset);
    UseMapObjectRes.AddMapObjectId(builder, map_object_id);
    UseMapObjectRes.AddResult(builder, result);
    return UseMapObjectRes.EndUseMapObjectRes(builder);
  }
