...
public struct ClientSyncReliableC2SEvt : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_7(); }
  public static ClientSyncReliableC2SEvt GetRootAsClientSyncReliableC2SEvt(ByteBuffer _bb) { return GetRootAsClientSyncReliableC2SEvt(_bb, new ClientSyncReliableC2SEvt()); }
  public static ClientSyncReliableC2SEvt GetRootAsClientSyncReliableC2SEvt(ByteBuffer _bb, ClientSyncReliableC2SEvt obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public ClientSyncReliableC2SEvt __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<SF.Flat.PlayInstance.ClientSyncReliableC2SEvt> CreateClientSyncReliableC2SEvt(FlatBufferBuilder builder,
      ulong play_instance_uid = 0,
      ulong player_id = 0,
      VectorOffset sync_dataOffset = default(VectorOffset)) {
    builder.StartTable(3);
    ClientSyncReliableC2SEvt.AddPlayerId(builder, player_id);
    ClientSyncReliableC2SEvt.AddPlayInstanceUid(builder, play_instance_uid);
    ClientSyncReliableC2SEvt.AddSyncData(builder, sync_dataOffset);
    return ClientSyncReliableC2SEvt.EndClientSyncReliableC2SEvt(builder);
  }

  public static void StartClientSyncReliableC2SEvt(FlatBufferBuilder builder) { builder.StartTable(3); }
  ...
  public static Offset<SF.Flat.PlayInstance.ClientSyncReliableC2SEvt> EndClientSyncReliableC2SEvt(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<SF.Flat.PlayInstance.ClientSyncReliableC2SEvt>(o);
  }
}


static public class ClientSyncReliableC2SEvtVerify
{
