...
public struct UGCEditDeleteCmd : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_7(); }
  public static UGCEditDeleteCmd GetRootAsUGCEditDeleteCmd(ByteBuffer _bb) { return GetRootAsUGCEditDeleteCmd(_bb, new UGCEditDeleteCmd()); }
  public static UGCEditDeleteCmd GetRootAsUGCEditDeleteCmd(ByteBuffer _bb, UGCEditDeleteCmd obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public UGCEditDeleteCmd __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static void StartUGCEditDeleteCmd(FlatBufferBuilder builder) { builder.StartTable(3); }
  ...
  public static Offset<SF.Flat.PlayInstance.UGCEditDeleteCmd> EndUGCEditDeleteCmd(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<SF.Flat.PlayInstance.UGCEditDeleteCmd>(o);
  }
}


static public class UGCEditDeleteCmdVerify
{
