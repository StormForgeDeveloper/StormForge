...
public struct WhiteboardSharingNewLogEntryAddedS2CEvt : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_23_5_26(); }
  public static WhiteboardSharingNewLogEntryAddedS2CEvt GetRootAsWhiteboardSharingNewLogEntryAddedS2CEvt(ByteBuffer _bb) { return GetRootAsWhiteboardSharingNewLogEntryAddedS2CEvt(_bb, new WhiteboardSharingNewLogEntryAddedS2CEvt()); }
  public static WhiteboardSharingNewLogEntryAddedS2CEvt GetRootAsWhiteboardSharingNewLogEntryAddedS2CEvt(ByteBuffer _bb, WhiteboardSharingNewLogEntryAddedS2CEvt obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  ...
  public static Offset<SF.Flat.PlayInstance.WhiteboardSharingNewLogEntryAddedS2CEvt> EndWhiteboardSharingNewLogEntryAddedS2CEvt(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<SF.Flat.PlayInstance.WhiteboardSharingNewLogEntryAddedS2CEvt>(o);
  }
}


static public class WhiteboardSharingNewLogEntryAddedS2CEvtVerify
{
