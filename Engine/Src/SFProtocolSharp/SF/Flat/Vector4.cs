...
public struct Vector4 : IFlatbufferObject
{
  ...
  public static Offset<SF.Flat.Vector4> CreateVector4(FlatBufferBuilder builder, float X, float Y, float Z, float W) {
    builder.Prep(4, 16);
    builder.PutFloat(W);
    builder.PutFloat(Z);
    builder.PutFloat(Y);
    builder.PutFloat(X);
    return new Offset<SF.Flat.Vector4>(builder.Offset);
  }
}
