...
public struct GenericError : IFlatbufferObject
{
  ...
  public static Offset<SF.Flat.Telemetry.GenericError> CreateGenericError(FlatBufferBuilder builder,
  ...
  public static Offset<SF.Flat.Telemetry.GenericError> EndGenericError(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    builder.Required(o, 4);  // reason
    return new Offset<SF.Flat.Telemetry.GenericError>(o);
  }
}
