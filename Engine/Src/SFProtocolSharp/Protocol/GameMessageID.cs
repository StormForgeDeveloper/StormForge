...
namespace SF.Net
{
	...
	public static class MessageIDGame
	{
		...
		public static readonly MessageID RequestGameMatchCmd = MessageID.MakeMessageID(EMessageType.Command, 1, SF.MessageProtocol.Game, 46);
		public static readonly MessageID RequestGameMatchRes = MessageID.MakeMessageID(EMessageType.Result, 1, SF.MessageProtocol.Game, 46);

		// S2C: Game matched
		public static readonly MessageID GameMatchedS2CEvt = MessageID.MakeMessageID(EMessageType.Event, 1, SF.MessageProtocol.Game, 47);
		// S2C: Game match failed
		public static readonly MessageID GameMatchFailedS2CEvt = MessageID.MakeMessageID(EMessageType.Event, 1, SF.MessageProtocol.Game, 48);
		// S2C: Game matching started
		public static readonly MessageID GameMatchingStartedS2CEvt = MessageID.MakeMessageID(EMessageType.Event, 1, SF.MessageProtocol.Game, 49);
		// Cmd: Cancel Game match
		public static readonly MessageID CancelGameMatchCmd = MessageID.MakeMessageID(EMessageType.Command, 1, SF.MessageProtocol.Game, 50);
		public static readonly MessageID CancelGameMatchRes = MessageID.MakeMessageID(EMessageType.Result, 1, SF.MessageProtocol.Game, 50);

		// S2C: game matching canceled
		public static readonly MessageID GameMatchingCanceledS2CEvt = MessageID.MakeMessageID(EMessageType.Event, 1, SF.MessageProtocol.Game, 51);
		...
		public static readonly MessageID GetMyUGCGamesCmd = MessageID.MakeMessageID(EMessageType.Command, 1, SF.MessageProtocol.Game, 52);
		public static readonly MessageID GetMyUGCGamesRes = MessageID.MakeMessageID(EMessageType.Result, 1, SF.MessageProtocol.Game, 52);
		...
		public static readonly MessageID BuyShopItemPrepareCmd = MessageID.MakeMessageID(EMessageType.Command, 1, SF.MessageProtocol.Game, 55);
		public static readonly MessageID BuyShopItemPrepareRes = MessageID.MakeMessageID(EMessageType.Result, 1, SF.MessageProtocol.Game, 55);

		// Cmd: Buy shop item
		public static readonly MessageID BuyShopItemCmd = MessageID.MakeMessageID(EMessageType.Command, 1, SF.MessageProtocol.Game, 56);
		public static readonly MessageID BuyShopItemRes = MessageID.MakeMessageID(EMessageType.Result, 1, SF.MessageProtocol.Game, 56);

		// Cmd: Create or Join Chat channel
		public static readonly MessageID CreateOrJoinChatChannelCmd = MessageID.MakeMessageID(EMessageType.Command, 1, SF.MessageProtocol.Game, 57);
		public static readonly MessageID CreateOrJoinChatChannelRes = MessageID.MakeMessageID(EMessageType.Result, 1, SF.MessageProtocol.Game, 57);

		// Cmd: Join
		public static readonly MessageID JoinChatChannelCmd = MessageID.MakeMessageID(EMessageType.Command, 1, SF.MessageProtocol.Game, 58);
		public static readonly MessageID JoinChatChannelRes = MessageID.MakeMessageID(EMessageType.Result, 1, SF.MessageProtocol.Game, 58);

		// S2C: Player Joined event
		public static readonly MessageID ChatChannelPlayerJoinedS2CEvt = MessageID.MakeMessageID(EMessageType.Event, 1, SF.MessageProtocol.Game, 59);
		// S2C: ChatChannel leader changed event
		public static readonly MessageID ChatChannelLeaderChangedS2CEvt = MessageID.MakeMessageID(EMessageType.Event, 1, SF.MessageProtocol.Game, 60);
		// Cmd: Leave ChatChannel command
		public static readonly MessageID LeaveChatChannelCmd = MessageID.MakeMessageID(EMessageType.Command, 1, SF.MessageProtocol.Game, 61);
		public static readonly MessageID LeaveChatChannelRes = MessageID.MakeMessageID(EMessageType.Result, 1, SF.MessageProtocol.Game, 61);

		// S2C: ChatChannel Player left event
		public static readonly MessageID ChatChannelPlayerLeftS2CEvt = MessageID.MakeMessageID(EMessageType.Event, 1, SF.MessageProtocol.Game, 62);
		// Cmd: Kick player from the ChatChannel
		public static readonly MessageID ChatChannelKickPlayerCmd = MessageID.MakeMessageID(EMessageType.Command, 1, SF.MessageProtocol.Game, 63);
		public static readonly MessageID ChatChannelKickPlayerRes = MessageID.MakeMessageID(EMessageType.Result, 1, SF.MessageProtocol.Game, 63);

		// S2C: ChatChannel Player kicked message
		public static readonly MessageID ChatChannelPlayerKickedS2CEvt = MessageID.MakeMessageID(EMessageType.Event, 1, SF.MessageProtocol.Game, 64);
		// Cmd: Chat channel sending chatting message
		public static readonly MessageID ChatChannelChatMessageCmd = MessageID.MakeMessageID(EMessageType.Command, 1, SF.MessageProtocol.Game, 65);
		public static readonly MessageID ChatChannelChatMessageRes = MessageID.MakeMessageID(EMessageType.Result, 1, SF.MessageProtocol.Game, 65);

		// S2C: ChatChannel Chatting message event
		public static readonly MessageID ChatChannelChatMessageS2CEvt = MessageID.MakeMessageID(EMessageType.Event, 1, SF.MessageProtocol.Game, 66);
		// Cmd: Whisper(tell) other player chatting
		public static readonly MessageID WhisperMessageCmd = MessageID.MakeMessageID(EMessageType.Command, 1, SF.MessageProtocol.Game, 67);
		public static readonly MessageID WhisperMessageRes = MessageID.MakeMessageID(EMessageType.Result, 1, SF.MessageProtocol.Game, 67);

		// S2C: Other player whispered(tell) to me message event
		public static readonly MessageID WhisperMessageS2CEvt = MessageID.MakeMessageID(EMessageType.Event, 1, SF.MessageProtocol.Game, 68);
		// Cmd: Create character
		public static readonly MessageID CreateCharacterCmd = MessageID.MakeMessageID(EMessageType.Command, 1, SF.MessageProtocol.Game, 69);
		public static readonly MessageID CreateCharacterRes = MessageID.MakeMessageID(EMessageType.Result, 1, SF.MessageProtocol.Game, 69);

		// Cmd: Delete character
		public static readonly MessageID DeleteCharacterCmd = MessageID.MakeMessageID(EMessageType.Command, 1, SF.MessageProtocol.Game, 70);
		public static readonly MessageID DeleteCharacterRes = MessageID.MakeMessageID(EMessageType.Result, 1, SF.MessageProtocol.Game, 70);

		// Cmd: Get character list
		public static readonly MessageID GetCharacterListCmd = MessageID.MakeMessageID(EMessageType.Command, 1, SF.MessageProtocol.Game, 71);
		public static readonly MessageID GetCharacterListRes = MessageID.MakeMessageID(EMessageType.Result, 1, SF.MessageProtocol.Game, 71);

		// Cmd: 
		public static readonly MessageID GetCharacterDataCmd = MessageID.MakeMessageID(EMessageType.Command, 1, SF.MessageProtocol.Game, 72);
		public static readonly MessageID GetCharacterDataRes = MessageID.MakeMessageID(EMessageType.Result, 1, SF.MessageProtocol.Game, 72);

		// Cmd: Select character
		public static readonly MessageID SelectCharacterCmd = MessageID.MakeMessageID(EMessageType.Command, 1, SF.MessageProtocol.Game, 73);
		public static readonly MessageID SelectCharacterRes = MessageID.MakeMessageID(EMessageType.Result, 1, SF.MessageProtocol.Game, 73);

		// Cmd: Request Server Notice. Sever will send ServerNoticeS2CEvt
		public static readonly MessageID RequestServerNoticeUpdateCmd = MessageID.MakeMessageID(EMessageType.Command, 1, SF.MessageProtocol.Game, 74);
		public static readonly MessageID RequestServerNoticeUpdateRes = MessageID.MakeMessageID(EMessageType.Result, 1, SF.MessageProtocol.Game, 74);

		// S2C: Server Notice updated event
		public static readonly MessageID ServerNoticeS2CEvt = MessageID.MakeMessageID(EMessageType.Event, 1, SF.MessageProtocol.Game, 75);
		// Cmd: To call general functionality
		public static readonly MessageID CallFunctionCmd = MessageID.MakeMessageID(EMessageType.Command, 1, SF.MessageProtocol.Game, 76);
		public static readonly MessageID CallFunctionRes = MessageID.MakeMessageID(EMessageType.Result, 1, SF.MessageProtocol.Game, 76);
