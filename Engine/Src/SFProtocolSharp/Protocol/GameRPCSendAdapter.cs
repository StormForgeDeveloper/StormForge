...
namespace SF.Net
{
	...
	public class GameRPCSendAdapter : RPCAdapter
	{
		...
		public  GameRPCSendAdapter( SF.SFConnection connection ) : base(connection)
		{
 		} // public  GameRPCSendAdapter( SF.SFConnection connection ) : base(connection)
		...
		public Result  FindPlayerByPlatformUserNameCmd( SF.TransactionID InTransactionID, System.Byte InPlatformType, System.String InPlatformUserName, Action<SFMessage>? callback = null )
		{
			...
			SF.Flat.Game.FindPlayerByPlatformUserNameCmd.AddPlatformType(builder, InPlatformType);
		...
		public Result  SearchGameInstanceCmd( SF.TransactionID InTransactionID, System.String InSearchKeyword, System.UInt32 InZoneTableID, Action<SFMessage>? callback = null )
		{
			...
			SF.Flat.Game.SearchGameInstanceCmd.AddZoneTableId(builder, InZoneTableID);
		...
		public Result  GetUGCTemplatesCmd( SF.TransactionID InTransactionID, System.String[] InTags, Action<SFMessage>? callback = null )
		{
			...
			SF.Flat.Game.GetUGCTemplatesCmd.StartGetUGCTemplatesCmd(builder);
			SF.Flat.Game.GetUGCTemplatesCmd.AddTags(builder, TagsOffset);
			var packetOffset = SF.Flat.Game.GetUGCTemplatesCmd.EndGetUGCTemplatesCmd(builder);
			result = SendMessage(MessageIDGame.GetUGCTemplatesCmd, builder, packetOffset.Value, transactionId:InTransactionID , callback:callback);
			return result;
		} // public Result  GetUGCTemplatesCmd( SF.TransactionID InTransactionID, System.String[] InTags, Action<SFMessage>? callback = null )
		...
		public Result  SaveUGCCmd( SF.TransactionID InTransactionID, SF.VariableTable InUGCMetaData, SF.VariableTable InUGCContents, Action<SFMessage>? callback = null )
		{
			...
			var UGCContentsOffset = builder.CreateVariableTable(InUGCContents);
			SF.Flat.Game.SaveUGCCmd.StartSaveUGCCmd(builder);
			SF.Flat.Game.SaveUGCCmd.AddUgcmetaData(builder, UGCMetaDataOffset);
			SF.Flat.Game.SaveUGCCmd.AddUgccontents(builder, UGCContentsOffset);
			var packetOffset = SF.Flat.Game.SaveUGCCmd.EndSaveUGCCmd(builder);
			result = SendMessage(MessageIDGame.SaveUGCCmd, builder, packetOffset.Value, transactionId:InTransactionID , callback:callback);
			return result;
		} // public Result  SaveUGCCmd( SF.TransactionID InTransactionID, SF.VariableTable InUGCMetaData, SF.VariableTable InUGCContents, Action<SFMessage>? callback = null )
		...
		public Result  SearchUGCCmd( SF.TransactionID InTransactionID, System.String[] InTags, Action<SFMessage>? callback = null )
		{
			...
			var builder = new Google.FlatBuffers.FlatBufferBuilder(1024);
			var TagsOffset = builder.CreateStringVector(InTags);
			SF.Flat.Game.SearchUGCCmd.StartSearchUGCCmd(builder);
			SF.Flat.Game.SearchUGCCmd.AddTags(builder, TagsOffset);
			var packetOffset = SF.Flat.Game.SearchUGCCmd.EndSearchUGCCmd(builder);
			result = SendMessage(MessageIDGame.SearchUGCCmd, builder, packetOffset.Value, transactionId:InTransactionID , callback:callback);
			return result;
		} // public Result  SearchUGCCmd( SF.TransactionID InTransactionID, System.String[] InTags, Action<SFMessage>? callback = null )
		...
		public Result  GetUGCContentInfoCmd( SF.TransactionID InTransactionID, UInt64 InUGCID, Action<SFMessage>? callback = null )
		{
			...
			SF.Flat.Game.GetUGCContentInfoCmd.AddUgcid(builder, InUGCID);
			var packetOffset = SF.Flat.Game.GetUGCContentInfoCmd.EndGetUGCContentInfoCmd(builder);
			result = SendMessage(MessageIDGame.GetUGCContentInfoCmd, builder, packetOffset.Value, transactionId:InTransactionID , callback:callback);
			return result;
		} // public Result  GetUGCContentInfoCmd( SF.TransactionID InTransactionID, UInt64 InUGCID, Action<SFMessage>? callback = null )
		...
		public Result  DownloadUGCContentCmd( SF.TransactionID InTransactionID, UInt64 InUGCID, System.Byte InIsIncludeMetaData, Action<SFMessage>? callback = null )
		{
			...
			SF.Flat.Game.DownloadUGCContentCmd.AddUgcid(builder, InUGCID);
			SF.Flat.Game.DownloadUGCContentCmd.AddIsIncludeMetaData(builder, InIsIncludeMetaData);
			var packetOffset = SF.Flat.Game.DownloadUGCContentCmd.EndDownloadUGCContentCmd(builder);
		...
		public Result  RequestUGCZoneInstanceCmd( SF.TransactionID InTransactionID, UInt64 InUGCID, Action<SFMessage>? callback = null )
		{
			...
			SF.Flat.Game.RequestUGCZoneInstanceCmd.AddUgcid(builder, InUGCID);
			var packetOffset = SF.Flat.Game.RequestUGCZoneInstanceCmd.EndRequestUGCZoneInstanceCmd(builder);
			result = SendMessage(MessageIDGame.RequestUGCZoneInstanceCmd, builder, packetOffset.Value, transactionId:InTransactionID , callback:callback);
			return result;
		} // public Result  RequestUGCZoneInstanceCmd( SF.TransactionID InTransactionID, UInt64 InUGCID, Action<SFMessage>? callback = null )
	...
	public class GameSvrRPCSendAdapter : RPCAdapter
	{
		...
		public  GameSvrRPCSendAdapter( SF.SFConnection connection ) : base(connection)
		{
 		} // public  GameSvrRPCSendAdapter( SF.SFConnection connection ) : base(connection)
		...
		public Result  GetUGCTemplatesRes( SF.TransactionID InTransactionID, SF.Result InResult, UInt64 InUGCIDs )
		{
			...
			SF.Flat.Game.GetUGCTemplatesRes.AddUgcids(builder, InUGCIDs);
			var packetOffset = SF.Flat.Game.GetUGCTemplatesRes.EndGetUGCTemplatesRes(builder);
			result = SendMessage(MessageIDGame.GetUGCTemplatesRes, builder, packetOffset.Value, transactionId:InTransactionID, result:InResult);
			return result;
		} // public Result  GetUGCTemplatesRes( SF.TransactionID InTransactionID, SF.Result InResult, UInt64 InUGCIDs )
		...
		public Result  SaveUGCRes( SF.TransactionID InTransactionID, SF.Result InResult, UInt64 InUGCID )
		{
			...
			SF.Flat.Game.SaveUGCRes.AddUgcid(builder, InUGCID);
			var packetOffset = SF.Flat.Game.SaveUGCRes.EndSaveUGCRes(builder);
			result = SendMessage(MessageIDGame.SaveUGCRes, builder, packetOffset.Value, transactionId:InTransactionID, result:InResult);
			return result;
		} // public Result  SaveUGCRes( SF.TransactionID InTransactionID, SF.Result InResult, UInt64 InUGCID )
		...
		public Result  SearchUGCRes( SF.TransactionID InTransactionID, SF.Result InResult )
		{
			...
			var packetOffset = SF.Flat.Game.SearchUGCRes.EndSearchUGCRes(builder);
			result = SendMessage(MessageIDGame.SearchUGCRes, builder, packetOffset.Value, transactionId:InTransactionID, result:InResult);
			return result;
		} // public Result  SearchUGCRes( SF.TransactionID InTransactionID, SF.Result InResult )
		...
		public Result  GetUGCContentInfoRes( SF.TransactionID InTransactionID, SF.Result InResult, SF.VariableTable InUGCMetaData )
		{
			...
			var builder = new Google.FlatBuffers.FlatBufferBuilder(1024);
			var UGCMetaDataOffset = builder.CreateVariableTable(InUGCMetaData);
			SF.Flat.Game.GetUGCContentInfoRes.StartGetUGCContentInfoRes(builder);
			SF.Flat.Game.GetUGCContentInfoRes.AddUgcmetaData(builder, UGCMetaDataOffset);
			var packetOffset = SF.Flat.Game.GetUGCContentInfoRes.EndGetUGCContentInfoRes(builder);
			result = SendMessage(MessageIDGame.GetUGCContentInfoRes, builder, packetOffset.Value, transactionId:InTransactionID, result:InResult);
			return result;
		} // public Result  GetUGCContentInfoRes( SF.TransactionID InTransactionID, SF.Result InResult, SF.VariableTable InUGCMetaData )
		...
		public Result  DownloadUGCContentRes( SF.TransactionID InTransactionID, SF.Result InResult, SF.VariableTable InUGCMetaData )
		{
			...
			var builder = new Google.FlatBuffers.FlatBufferBuilder(1024);
			var UGCMetaDataOffset = builder.CreateVariableTable(InUGCMetaData);
			SF.Flat.Game.DownloadUGCContentRes.StartDownloadUGCContentRes(builder);
			SF.Flat.Game.DownloadUGCContentRes.AddUgcmetaData(builder, UGCMetaDataOffset);
			var packetOffset = SF.Flat.Game.DownloadUGCContentRes.EndDownloadUGCContentRes(builder);
		...
		public Result  RequestUGCZoneInstanceRes( SF.TransactionID InTransactionID, SF.Result InResult, SF.VariableTable InGameInstance )
		{
			...
			SF.Flat.Game.RequestUGCZoneInstanceRes.StartRequestUGCZoneInstanceRes(builder);
			SF.Flat.Game.RequestUGCZoneInstanceRes.AddGameInstance(builder, GameInstanceOffset);
			var packetOffset = SF.Flat.Game.RequestUGCZoneInstanceRes.EndRequestUGCZoneInstanceRes(builder);
			result = SendMessage(MessageIDGame.RequestUGCZoneInstanceRes, builder, packetOffset.Value, transactionId:InTransactionID, result:InResult);
			return result;
		} // public Result  RequestUGCZoneInstanceRes( SF.TransactionID InTransactionID, SF.Result InResult, SF.VariableTable InGameInstance )
