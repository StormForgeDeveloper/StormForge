...
namespace SF.Net
{
	...
	public static class MessageIDGeneric
	{
		...
		public static readonly MessageID PostLogDataCmd = MessageID.MakeMessageID(EMessageType.Command, 1, SF.MessageProtocol.Generic, 2);
		public static readonly MessageID PostLogDataRes = MessageID.MakeMessageID(EMessageType.Result, 1, SF.MessageProtocol.Generic, 2);
