...
namespace SF
{
	...
	Result GameMessageLog::HeartbeatC2SEvt(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:HeartbeatC2SEvt: size:{1}", prefix, messageHeader->MessageSize);
	...
	Result GameMessageLog::JoinGameServerCmd(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:JoinGameServerCmd: tid:{1}, size:{2}", prefix, messageHeader->TransactionId, messageHeader->MessageSize);
	...
	Result GameMessageLog::JoinGameServerRes(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:JoinGameServerRes: tid:{1}, Result:{2} size:{3}", prefix, messageHeader->TransactionId, messageHeader->GetTransactionResult(), messageHeader->MessageSize);
	...
	Result GameMessageLog::GetAchievementStatsCmd(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:GetAchievementStatsCmd: tid:{1}, size:{2}", prefix, messageHeader->TransactionId, messageHeader->MessageSize);
	...
	Result GameMessageLog::GetAchievementStatsRes(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:GetAchievementStatsRes: tid:{1}, Result:{2} size:{3}", prefix, messageHeader->TransactionId, messageHeader->GetTransactionResult(), messageHeader->MessageSize);
	...
	Result GameMessageLog::Dummy1Cmd(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:Dummy1Cmd: tid:{1}, size:{2}", prefix, messageHeader->TransactionId, messageHeader->MessageSize);
	...
	Result GameMessageLog::Dummy1Res(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:Dummy1Res: tid:{1}, Result:{2} size:{3}", prefix, messageHeader->TransactionId, messageHeader->GetTransactionResult(), messageHeader->MessageSize);
	...
	Result GameMessageLog::RegisterGCMCmd(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:RegisterGCMCmd: tid:{1}, size:{2}", prefix, messageHeader->TransactionId, messageHeader->MessageSize);
	...
	Result GameMessageLog::RegisterGCMRes(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:RegisterGCMRes: tid:{1}, Result:{2} size:{3}", prefix, messageHeader->TransactionId, messageHeader->GetTransactionResult(), messageHeader->MessageSize);
	...
	Result GameMessageLog::UnregisterGCMCmd(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:UnregisterGCMCmd: tid:{1}, size:{2}", prefix, messageHeader->TransactionId, messageHeader->MessageSize);
	...
	Result GameMessageLog::UnregisterGCMRes(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:UnregisterGCMRes: tid:{1}, Result:{2} size:{3}", prefix, messageHeader->TransactionId, messageHeader->GetTransactionResult(), messageHeader->MessageSize);
	...
	Result GameMessageLog::InviteFriendCmd(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:InviteFriendCmd: tid:{1}, size:{2}", prefix, messageHeader->TransactionId, messageHeader->MessageSize);
	...
	Result GameMessageLog::InviteFriendRes(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:InviteFriendRes: tid:{1}, Result:{2} size:{3}", prefix, messageHeader->TransactionId, messageHeader->GetTransactionResult(), messageHeader->MessageSize);
	...
	Result GameMessageLog::AcceptFriendRequestCmd(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:AcceptFriendRequestCmd: tid:{1}, size:{2}", prefix, messageHeader->TransactionId, messageHeader->MessageSize);
	...
	Result GameMessageLog::AcceptFriendRequestRes(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:AcceptFriendRequestRes: tid:{1}, Result:{2} size:{3}", prefix, messageHeader->TransactionId, messageHeader->GetTransactionResult(), messageHeader->MessageSize);
	...
	Result GameMessageLog::FriendRequestAcceptedS2CEvt(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:FriendRequestAcceptedS2CEvt: size:{1}", prefix, messageHeader->MessageSize);
	...
	Result GameMessageLog::RemoveFriendCmd(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:RemoveFriendCmd: tid:{1}, size:{2}", prefix, messageHeader->TransactionId, messageHeader->MessageSize);
	...
	Result GameMessageLog::RemoveFriendRes(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:RemoveFriendRes: tid:{1}, Result:{2} size:{3}", prefix, messageHeader->TransactionId, messageHeader->GetTransactionResult(), messageHeader->MessageSize);
	...
	Result GameMessageLog::FriendRemovedS2CEvt(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:FriendRemovedS2CEvt: size:{1}", prefix, messageHeader->MessageSize);
	...
	Result GameMessageLog::GetFriendListCmd(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:GetFriendListCmd: tid:{1}, size:{2}", prefix, messageHeader->TransactionId, messageHeader->MessageSize);
	...
	Result GameMessageLog::GetFriendListRes(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:GetFriendListRes: tid:{1}, Result:{2} size:{3}", prefix, messageHeader->TransactionId, messageHeader->GetTransactionResult(), messageHeader->MessageSize);
	...
	Result GameMessageLog::GetNotificationListCmd(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:GetNotificationListCmd: tid:{1}, size:{2}", prefix, messageHeader->TransactionId, messageHeader->MessageSize);
	...
	Result GameMessageLog::GetNotificationListRes(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:GetNotificationListRes: tid:{1}, Result:{2} size:{3}", prefix, messageHeader->TransactionId, messageHeader->GetTransactionResult(), messageHeader->MessageSize);
	...
	Result GameMessageLog::DeleteNotificationCmd(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:DeleteNotificationCmd: tid:{1}, size:{2}", prefix, messageHeader->TransactionId, messageHeader->MessageSize);
	...
	Result GameMessageLog::DeleteNotificationRes(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:DeleteNotificationRes: tid:{1}, Result:{2} size:{3}", prefix, messageHeader->TransactionId, messageHeader->GetTransactionResult(), messageHeader->MessageSize);
	...
	Result GameMessageLog::SetNotificationReadCmd(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:SetNotificationReadCmd: tid:{1}, size:{2}", prefix, messageHeader->TransactionId, messageHeader->MessageSize);
	...
	Result GameMessageLog::SetNotificationReadRes(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:SetNotificationReadRes: tid:{1}, Result:{2} size:{3}", prefix, messageHeader->TransactionId, messageHeader->GetTransactionResult(), messageHeader->MessageSize);
	...
	Result GameMessageLog::AcceptNotificationCmd(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:AcceptNotificationCmd: tid:{1}, size:{2}", prefix, messageHeader->TransactionId, messageHeader->MessageSize);
	...
	Result GameMessageLog::AcceptNotificationRes(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:AcceptNotificationRes: tid:{1}, Result:{2} size:{3}", prefix, messageHeader->TransactionId, messageHeader->GetTransactionResult(), messageHeader->MessageSize);
	...
	Result GameMessageLog::NotifyS2CEvt(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:NotifyS2CEvt: size:{1}", prefix, messageHeader->MessageSize);
	...
	Result GameMessageLog::FindPlayerByPlatformIdCmd(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:FindPlayerByPlatformIdCmd: tid:{1}, size:{2}", prefix, messageHeader->TransactionId, messageHeader->MessageSize);
	...
	Result GameMessageLog::FindPlayerByPlatformIdRes(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:FindPlayerByPlatformIdRes: tid:{1}, Result:{2} size:{3}", prefix, messageHeader->TransactionId, messageHeader->GetTransactionResult(), messageHeader->MessageSize);
	...
	Result GameMessageLog::FindPlayerByCharacterNameCmd(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:FindPlayerByCharacterNameCmd: tid:{1}, size:{2}", prefix, messageHeader->TransactionId, messageHeader->MessageSize);
	...
	Result GameMessageLog::FindPlayerByCharacterNameRes(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:FindPlayerByCharacterNameRes: tid:{1}, Result:{2} size:{3}", prefix, messageHeader->TransactionId, messageHeader->GetTransactionResult(), messageHeader->MessageSize);
	...
	Result GameMessageLog::FindPlayerByPlatformUserNameCmd(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:FindPlayerByPlatformUserNameCmd: tid:{1}, size:{2}", prefix, messageHeader->TransactionId, messageHeader->MessageSize);
	...
	Result GameMessageLog::FindPlayerByPlatformUserNameRes(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:FindPlayerByPlatformUserNameRes: tid:{1}, Result:{2} size:{3}", prefix, messageHeader->TransactionId, messageHeader->GetTransactionResult(), messageHeader->MessageSize);
	...
	Result GameMessageLog::FindPlayerByEMailCmd(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:FindPlayerByEMailCmd: tid:{1}, size:{2}", prefix, messageHeader->TransactionId, messageHeader->MessageSize);
	...
	Result GameMessageLog::FindPlayerByEMailRes(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:FindPlayerByEMailRes: tid:{1}, Result:{2} size:{3}", prefix, messageHeader->TransactionId, messageHeader->GetTransactionResult(), messageHeader->MessageSize);
	...
	Result GameMessageLog::FindPlayerByPlayerIDCmd(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:FindPlayerByPlayerIDCmd: tid:{1}, size:{2}", prefix, messageHeader->TransactionId, messageHeader->MessageSize);
	...
	Result GameMessageLog::FindPlayerByPlayerIDRes(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:FindPlayerByPlayerIDRes: tid:{1}, Result:{2} size:{3}", prefix, messageHeader->TransactionId, messageHeader->GetTransactionResult(), messageHeader->MessageSize);
	...
	Result GameMessageLog::RequestPlayerStatusUpdateCmd(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:RequestPlayerStatusUpdateCmd: tid:{1}, size:{2}", prefix, messageHeader->TransactionId, messageHeader->MessageSize);
	...
	Result GameMessageLog::RequestPlayerStatusUpdateRes(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:RequestPlayerStatusUpdateRes: tid:{1}, Result:{2} size:{3}", prefix, messageHeader->TransactionId, messageHeader->GetTransactionResult(), messageHeader->MessageSize);
	...
	Result GameMessageLog::NotifyPlayerStatusUpdatedS2CEvt(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:NotifyPlayerStatusUpdatedS2CEvt: size:{1}", prefix, messageHeader->MessageSize);
	...
	Result GameMessageLog::GetRankingListCmd(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:GetRankingListCmd: tid:{1}, size:{2}", prefix, messageHeader->TransactionId, messageHeader->MessageSize);
	...
	Result GameMessageLog::GetRankingListRes(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:GetRankingListRes: tid:{1}, Result:{2} size:{3}", prefix, messageHeader->TransactionId, messageHeader->GetTransactionResult(), messageHeader->MessageSize);
	...
	Result GameMessageLog::GetUserGamePlayerInfoCmd(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:GetUserGamePlayerInfoCmd: tid:{1}, size:{2}", prefix, messageHeader->TransactionId, messageHeader->MessageSize);
	...
	Result GameMessageLog::GetUserGamePlayerInfoRes(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:GetUserGamePlayerInfoRes: tid:{1}, Result:{2} size:{3}", prefix, messageHeader->TransactionId, messageHeader->GetTransactionResult(), messageHeader->MessageSize);
	...
	Result GameMessageLog::GetGamePlayerInfoCmd(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:GetGamePlayerInfoCmd: tid:{1}, size:{2}", prefix, messageHeader->TransactionId, messageHeader->MessageSize);
	...
	Result GameMessageLog::GetGamePlayerInfoRes(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:GetGamePlayerInfoRes: tid:{1}, Result:{2} size:{3}", prefix, messageHeader->TransactionId, messageHeader->GetTransactionResult(), messageHeader->MessageSize);
	...
	Result GameMessageLog::LevelUpS2CEvt(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:LevelUpS2CEvt: size:{1}", prefix, messageHeader->MessageSize);
	...
	Result GameMessageLog::SetNickNameCmd(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:SetNickNameCmd: tid:{1}, size:{2}", prefix, messageHeader->TransactionId, messageHeader->MessageSize);
	...
	Result GameMessageLog::SetNickNameRes(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:SetNickNameRes: tid:{1}, Result:{2} size:{3}", prefix, messageHeader->TransactionId, messageHeader->GetTransactionResult(), messageHeader->MessageSize);
	...
	Result GameMessageLog::CreatePartyCmd(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:CreatePartyCmd: tid:{1}, size:{2}", prefix, messageHeader->TransactionId, messageHeader->MessageSize);
	...
	Result GameMessageLog::CreatePartyRes(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:CreatePartyRes: tid:{1}, Result:{2} size:{3}", prefix, messageHeader->TransactionId, messageHeader->GetTransactionResult(), messageHeader->MessageSize);
	...
	Result GameMessageLog::JoinPartyCmd(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:JoinPartyCmd: tid:{1}, size:{2}", prefix, messageHeader->TransactionId, messageHeader->MessageSize);
	...
	Result GameMessageLog::JoinPartyRes(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:JoinPartyRes: tid:{1}, Result:{2} size:{3}", prefix, messageHeader->TransactionId, messageHeader->GetTransactionResult(), messageHeader->MessageSize);
	...
	Result GameMessageLog::PartyPlayerJoinedS2CEvt(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:PartyPlayerJoinedS2CEvt: size:{1}", prefix, messageHeader->MessageSize);
	...
	Result GameMessageLog::PartyLeaderChangedS2CEvt(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:PartyLeaderChangedS2CEvt: size:{1}", prefix, messageHeader->MessageSize);
	...
	Result GameMessageLog::LeavePartyCmd(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:LeavePartyCmd: tid:{1}, size:{2}", prefix, messageHeader->TransactionId, messageHeader->MessageSize);
	...
	Result GameMessageLog::LeavePartyRes(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:LeavePartyRes: tid:{1}, Result:{2} size:{3}", prefix, messageHeader->TransactionId, messageHeader->GetTransactionResult(), messageHeader->MessageSize);
	...
	Result GameMessageLog::PartyPlayerLeftS2CEvt(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:PartyPlayerLeftS2CEvt: size:{1}", prefix, messageHeader->MessageSize);
	...
	Result GameMessageLog::PartyKickPlayerCmd(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:PartyKickPlayerCmd: tid:{1}, size:{2}", prefix, messageHeader->TransactionId, messageHeader->MessageSize);
	...
	Result GameMessageLog::PartyKickPlayerRes(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:PartyKickPlayerRes: tid:{1}, Result:{2} size:{3}", prefix, messageHeader->TransactionId, messageHeader->GetTransactionResult(), messageHeader->MessageSize);
	...
	Result GameMessageLog::PartyPlayerKickedS2CEvt(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:PartyPlayerKickedS2CEvt: size:{1}", prefix, messageHeader->MessageSize);
	...
	Result GameMessageLog::PartyInviteCmd(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:PartyInviteCmd: tid:{1}, size:{2}", prefix, messageHeader->TransactionId, messageHeader->MessageSize);
	...
	Result GameMessageLog::PartyInviteRes(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:PartyInviteRes: tid:{1}, Result:{2} size:{3}", prefix, messageHeader->TransactionId, messageHeader->GetTransactionResult(), messageHeader->MessageSize);
	...
	Result GameMessageLog::PartyInviteRequestedS2CEvt(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:PartyInviteRequestedS2CEvt: size:{1}", prefix, messageHeader->MessageSize);
	...
	Result GameMessageLog::PartyQuickChatMessageCmd(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:PartyQuickChatMessageCmd: tid:{1}, size:{2}", prefix, messageHeader->TransactionId, messageHeader->MessageSize);
	...
	Result GameMessageLog::PartyQuickChatMessageRes(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:PartyQuickChatMessageRes: tid:{1}, Result:{2} size:{3}", prefix, messageHeader->TransactionId, messageHeader->GetTransactionResult(), messageHeader->MessageSize);
	...
	Result GameMessageLog::PartyQuickChatMessageS2CEvt(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:PartyQuickChatMessageS2CEvt: size:{1}", prefix, messageHeader->MessageSize);
	...
	Result GameMessageLog::PartyChatMessageCmd(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:PartyChatMessageCmd: tid:{1}, size:{2}", prefix, messageHeader->TransactionId, messageHeader->MessageSize);
	...
	Result GameMessageLog::PartyChatMessageRes(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:PartyChatMessageRes: tid:{1}, Result:{2} size:{3}", prefix, messageHeader->TransactionId, messageHeader->GetTransactionResult(), messageHeader->MessageSize);
	...
	Result GameMessageLog::PartyChatMessageS2CEvt(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:PartyChatMessageS2CEvt: size:{1}", prefix, messageHeader->MessageSize);
	...
	Result GameMessageLog::JoinGameInstanceCmd(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:JoinGameInstanceCmd: tid:{1}, size:{2}", prefix, messageHeader->TransactionId, messageHeader->MessageSize);
	...
	Result GameMessageLog::JoinGameInstanceRes(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:JoinGameInstanceRes: tid:{1}, Result:{2} size:{3}", prefix, messageHeader->TransactionId, messageHeader->GetTransactionResult(), messageHeader->MessageSize);
	...
	Result GameMessageLog::LeaveGameInstanceCmd(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:LeaveGameInstanceCmd: tid:{1}, size:{2}", prefix, messageHeader->TransactionId, messageHeader->MessageSize);
	...
	Result GameMessageLog::LeaveGameInstanceRes(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:LeaveGameInstanceRes: tid:{1}, Result:{2} size:{3}", prefix, messageHeader->TransactionId, messageHeader->GetTransactionResult(), messageHeader->MessageSize);
	...
	Result GameMessageLog::SearchGameInstanceCmd(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:SearchGameInstanceCmd: tid:{1}, size:{2}", prefix, messageHeader->TransactionId, messageHeader->MessageSize);
	...
	Result GameMessageLog::SearchGameInstanceRes(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:SearchGameInstanceRes: tid:{1}, Result:{2} size:{3}", prefix, messageHeader->TransactionId, messageHeader->GetTransactionResult(), messageHeader->MessageSize);
	...
	Result GameMessageLog::GetCharacterDataInGameInstanceCmd(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:GetCharacterDataInGameInstanceCmd: tid:{1}, size:{2}", prefix, messageHeader->TransactionId, messageHeader->MessageSize);
	...
	Result GameMessageLog::GetCharacterDataInGameInstanceRes(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:GetCharacterDataInGameInstanceRes: tid:{1}, Result:{2} size:{3}", prefix, messageHeader->TransactionId, messageHeader->GetTransactionResult(), messageHeader->MessageSize);
	...
	Result GameMessageLog::RequestGameMatchCmd(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:RequestGameMatchCmd: tid:{1}, size:{2}", prefix, messageHeader->TransactionId, messageHeader->MessageSize);
	...
	Result GameMessageLog::RequestGameMatchRes(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:RequestGameMatchRes: tid:{1}, Result:{2} size:{3}", prefix, messageHeader->TransactionId, messageHeader->GetTransactionResult(), messageHeader->MessageSize);
	...
	Result GameMessageLog::GameMatchedS2CEvt(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:GameMatchedS2CEvt: size:{1}", prefix, messageHeader->MessageSize);
	...
	Result GameMessageLog::GameMatchFailedS2CEvt(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:GameMatchFailedS2CEvt: size:{1}", prefix, messageHeader->MessageSize);
	...
	Result GameMessageLog::GameMatchingStartedS2CEvt(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:GameMatchingStartedS2CEvt: size:{1}", prefix, messageHeader->MessageSize);
	...
	Result GameMessageLog::CancelGameMatchCmd(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:CancelGameMatchCmd: tid:{1}, size:{2}", prefix, messageHeader->TransactionId, messageHeader->MessageSize);
	...
	Result GameMessageLog::CancelGameMatchRes(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:CancelGameMatchRes: tid:{1}, Result:{2} size:{3}", prefix, messageHeader->TransactionId, messageHeader->GetTransactionResult(), messageHeader->MessageSize);
	...
	Result GameMessageLog::GameMatchingCanceledS2CEvt(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:GameMatchingCanceledS2CEvt: size:{1}", prefix, messageHeader->MessageSize);
	...
	Result GameMessageLog::GetUGCTemplatesCmd(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:GetUGCTemplatesCmd: tid:{1}, size:{2}", prefix, messageHeader->TransactionId, messageHeader->MessageSize);
	...
	Result GameMessageLog::GetUGCTemplatesRes(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:GetUGCTemplatesRes: tid:{1}, Result:{2} size:{3}", prefix, messageHeader->TransactionId, messageHeader->GetTransactionResult(), messageHeader->MessageSize);
	...
	Result GameMessageLog::SaveUGCCmd(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:SaveUGCCmd: tid:{1}, size:{2}", prefix, messageHeader->TransactionId, messageHeader->MessageSize);
	...
	Result GameMessageLog::SaveUGCRes(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:SaveUGCRes: tid:{1}, Result:{2} size:{3}", prefix, messageHeader->TransactionId, messageHeader->GetTransactionResult(), messageHeader->MessageSize);
	...
	Result GameMessageLog::SearchUGCCmd(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:SearchUGCCmd: tid:{1}, size:{2}", prefix, messageHeader->TransactionId, messageHeader->MessageSize);
	...
	Result GameMessageLog::SearchUGCRes(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:SearchUGCRes: tid:{1}, Result:{2} size:{3}", prefix, messageHeader->TransactionId, messageHeader->GetTransactionResult(), messageHeader->MessageSize);
	...
	Result GameMessageLog::GetUGCContentInfoCmd(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:GetUGCContentInfoCmd: tid:{1}, size:{2}", prefix, messageHeader->TransactionId, messageHeader->MessageSize);
	...
	Result GameMessageLog::GetUGCContentInfoRes(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:GetUGCContentInfoRes: tid:{1}, Result:{2} size:{3}", prefix, messageHeader->TransactionId, messageHeader->GetTransactionResult(), messageHeader->MessageSize);
	...
	Result GameMessageLog::DownloadUGCContentCmd(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:DownloadUGCContentCmd: tid:{1}, size:{2}", prefix, messageHeader->TransactionId, messageHeader->MessageSize);
	...
	Result GameMessageLog::DownloadUGCContentRes(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:DownloadUGCContentRes: tid:{1}, Result:{2} size:{3}", prefix, messageHeader->TransactionId, messageHeader->GetTransactionResult(), messageHeader->MessageSize);
	...
	Result GameMessageLog::RequestUGCZoneInstanceCmd(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:RequestUGCZoneInstanceCmd: tid:{1}, size:{2}", prefix, messageHeader->TransactionId, messageHeader->MessageSize);
	...
	Result GameMessageLog::RequestUGCZoneInstanceRes(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:RequestUGCZoneInstanceRes: tid:{1}, Result:{2} size:{3}", prefix, messageHeader->TransactionId, messageHeader->GetTransactionResult(), messageHeader->MessageSize);
	...
	Result GameMessageLog::BuyShopItemPrepareCmd(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:BuyShopItemPrepareCmd: tid:{1}, size:{2}", prefix, messageHeader->TransactionId, messageHeader->MessageSize);
	...
	Result GameMessageLog::BuyShopItemPrepareRes(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:BuyShopItemPrepareRes: tid:{1}, Result:{2} size:{3}", prefix, messageHeader->TransactionId, messageHeader->GetTransactionResult(), messageHeader->MessageSize);
	...
	Result GameMessageLog::BuyShopItemCmd(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:BuyShopItemCmd: tid:{1}, size:{2}", prefix, messageHeader->TransactionId, messageHeader->MessageSize);
	...
	Result GameMessageLog::BuyShopItemRes(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:BuyShopItemRes: tid:{1}, Result:{2} size:{3}", prefix, messageHeader->TransactionId, messageHeader->GetTransactionResult(), messageHeader->MessageSize);
	...
	Result GameMessageLog::CreateOrJoinChatChannelCmd(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:CreateOrJoinChatChannelCmd: tid:{1}, size:{2}", prefix, messageHeader->TransactionId, messageHeader->MessageSize);
	...
	Result GameMessageLog::CreateOrJoinChatChannelRes(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:CreateOrJoinChatChannelRes: tid:{1}, Result:{2} size:{3}", prefix, messageHeader->TransactionId, messageHeader->GetTransactionResult(), messageHeader->MessageSize);
	...
	Result GameMessageLog::JoinChatChannelCmd(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:JoinChatChannelCmd: tid:{1}, size:{2}", prefix, messageHeader->TransactionId, messageHeader->MessageSize);
	...
	Result GameMessageLog::JoinChatChannelRes(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:JoinChatChannelRes: tid:{1}, Result:{2} size:{3}", prefix, messageHeader->TransactionId, messageHeader->GetTransactionResult(), messageHeader->MessageSize);
	...
	Result GameMessageLog::ChatChannelPlayerJoinedS2CEvt(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:ChatChannelPlayerJoinedS2CEvt: size:{1}", prefix, messageHeader->MessageSize);
	...
	Result GameMessageLog::ChatChannelLeaderChangedS2CEvt(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:ChatChannelLeaderChangedS2CEvt: size:{1}", prefix, messageHeader->MessageSize);
	...
	Result GameMessageLog::LeaveChatChannelCmd(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:LeaveChatChannelCmd: tid:{1}, size:{2}", prefix, messageHeader->TransactionId, messageHeader->MessageSize);
	...
	Result GameMessageLog::LeaveChatChannelRes(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:LeaveChatChannelRes: tid:{1}, Result:{2} size:{3}", prefix, messageHeader->TransactionId, messageHeader->GetTransactionResult(), messageHeader->MessageSize);
	...
	Result GameMessageLog::ChatChannelPlayerLeftS2CEvt(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:ChatChannelPlayerLeftS2CEvt: size:{1}", prefix, messageHeader->MessageSize);
	...
	Result GameMessageLog::ChatChannelKickPlayerCmd(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:ChatChannelKickPlayerCmd: tid:{1}, size:{2}", prefix, messageHeader->TransactionId, messageHeader->MessageSize);
	...
	Result GameMessageLog::ChatChannelKickPlayerRes(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:ChatChannelKickPlayerRes: tid:{1}, Result:{2} size:{3}", prefix, messageHeader->TransactionId, messageHeader->GetTransactionResult(), messageHeader->MessageSize);
	...
	Result GameMessageLog::ChatChannelPlayerKickedS2CEvt(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:ChatChannelPlayerKickedS2CEvt: size:{1}", prefix, messageHeader->MessageSize);
	...
	Result GameMessageLog::ChatChannelChatMessageCmd(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:ChatChannelChatMessageCmd: tid:{1}, size:{2}", prefix, messageHeader->TransactionId, messageHeader->MessageSize);
	...
	Result GameMessageLog::ChatChannelChatMessageRes(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:ChatChannelChatMessageRes: tid:{1}, Result:{2} size:{3}", prefix, messageHeader->TransactionId, messageHeader->GetTransactionResult(), messageHeader->MessageSize);
	...
	Result GameMessageLog::ChatChannelChatMessageS2CEvt(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:ChatChannelChatMessageS2CEvt: size:{1}", prefix, messageHeader->MessageSize);
	...
	Result GameMessageLog::WhisperMessageCmd(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:WhisperMessageCmd: tid:{1}, size:{2}", prefix, messageHeader->TransactionId, messageHeader->MessageSize);
	...
	Result GameMessageLog::WhisperMessageRes(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:WhisperMessageRes: tid:{1}, Result:{2} size:{3}", prefix, messageHeader->TransactionId, messageHeader->GetTransactionResult(), messageHeader->MessageSize);
	...
	Result GameMessageLog::WhisperMessageS2CEvt(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:WhisperMessageS2CEvt: size:{1}", prefix, messageHeader->MessageSize);
	...
	Result GameMessageLog::CreateCharacterCmd(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:CreateCharacterCmd: tid:{1}, size:{2}", prefix, messageHeader->TransactionId, messageHeader->MessageSize);
	...
	Result GameMessageLog::CreateCharacterRes(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:CreateCharacterRes: tid:{1}, Result:{2} size:{3}", prefix, messageHeader->TransactionId, messageHeader->GetTransactionResult(), messageHeader->MessageSize);
	...
	Result GameMessageLog::DeleteCharacterCmd(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:DeleteCharacterCmd: tid:{1}, size:{2}", prefix, messageHeader->TransactionId, messageHeader->MessageSize);
	...
	Result GameMessageLog::DeleteCharacterRes(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:DeleteCharacterRes: tid:{1}, Result:{2} size:{3}", prefix, messageHeader->TransactionId, messageHeader->GetTransactionResult(), messageHeader->MessageSize);
	...
	Result GameMessageLog::GetCharacterListCmd(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:GetCharacterListCmd: tid:{1}, size:{2}", prefix, messageHeader->TransactionId, messageHeader->MessageSize);
	...
	Result GameMessageLog::GetCharacterListRes(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:GetCharacterListRes: tid:{1}, Result:{2} size:{3}", prefix, messageHeader->TransactionId, messageHeader->GetTransactionResult(), messageHeader->MessageSize);
	...
	Result GameMessageLog::GetCharacterDataCmd(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:GetCharacterDataCmd: tid:{1}, size:{2}", prefix, messageHeader->TransactionId, messageHeader->MessageSize);
	...
	Result GameMessageLog::GetCharacterDataRes(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:GetCharacterDataRes: tid:{1}, Result:{2} size:{3}", prefix, messageHeader->TransactionId, messageHeader->GetTransactionResult(), messageHeader->MessageSize);
	...
	Result GameMessageLog::SelectCharacterCmd(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:SelectCharacterCmd: tid:{1}, size:{2}", prefix, messageHeader->TransactionId, messageHeader->MessageSize);
	...
	Result GameMessageLog::SelectCharacterRes(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:SelectCharacterRes: tid:{1}, Result:{2} size:{3}", prefix, messageHeader->TransactionId, messageHeader->GetTransactionResult(), messageHeader->MessageSize);
	...
	Result GameMessageLog::RequestServerNoticeUpdateCmd(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:RequestServerNoticeUpdateCmd: tid:{1}, size:{2}", prefix, messageHeader->TransactionId, messageHeader->MessageSize);
	...
	Result GameMessageLog::RequestServerNoticeUpdateRes(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:RequestServerNoticeUpdateRes: tid:{1}, Result:{2} size:{3}", prefix, messageHeader->TransactionId, messageHeader->GetTransactionResult(), messageHeader->MessageSize);
	...
	Result GameMessageLog::ServerNoticeS2CEvt(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:ServerNoticeS2CEvt: size:{1}", prefix, messageHeader->MessageSize);
	...
	Result GameMessageLog::CallFunctionCmd(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:CallFunctionCmd: tid:{1}, size:{2}", prefix, messageHeader->TransactionId, messageHeader->MessageSize);
	...
	Result GameMessageLog::CallFunctionRes(const char* prefix, const MessageHeader* messageHeader)
	{
		...
		SFLog(Net, Debug, "{0} Game:CallFunctionRes: tid:{1}, Result:{2} size:{3}", prefix, messageHeader->TransactionId, messageHeader->GetTransactionResult(), messageHeader->MessageSize);
