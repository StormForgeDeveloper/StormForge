...
namespace SF
{
	...
	Result NetPolicyGame::GetAchievementStatsCmd( const TransactionID &InTransactionID, const uint32_t &InCharacterID, const uint32_t &InAchievementStatIDFrom, const uint32_t &InAchievementStatIDTo )
	{
 		Result hr;
	...
	Result NetPolicyGame::Dummy1Cmd( const TransactionID &InTransactionID, const char* InComplitionState )
	{
 		Result hr;
	...
	Result NetPolicyGame::AcceptFriendRequestCmd( const TransactionID &InTransactionID, const AccountID &InInviterID, const PlayerPlatformID &InInviterPlatformId )
	{
 		Result hr;
	...
	Result NetPolicyGame::FindPlayerByPlatformIdCmd( const TransactionID &InTransactionID, const PlayerPlatformID &InPlatformPlayerId )
	{
 		Result hr;
	...
	// Cmd: PlayerId conversion
	Result NetPolicyGame::FindPlayerByCharacterNameCmd( const TransactionID &InTransactionID, const char* InCharacterName )
	{
 		Result hr;
	...
	// Cmd: PlayerId Conversion
	Result NetPolicyGame::FindPlayerByPlatformUserNameCmd( const TransactionID &InTransactionID, const uint8_t &InPlatformType, const char* InPlatformUserName )
	{
 		Result hr;
	...
	Result NetPolicyGame::JoinGameInstanceCmd( const TransactionID &InTransactionID, const uint64_t &InInsUID )
	{
 		Result hr;
	...
	Result NetPolicyGame::LeaveGameInstanceCmd( const TransactionID &InTransactionID, const uint64_t &InInsUID )
	{
 		Result hr;
	...
	Result NetPolicyGame::SearchGameInstanceCmd( const TransactionID &InTransactionID, const char* InSearchKeyword, const uint32_t &InZoneTableID )
	{
 		Result hr;
	...
	// Cmd: Search game instance
	Result NetPolicyGame::GetCharacterDataInGameInstanceCmd( const TransactionID &InTransactionID, const uint64_t &InGameInsUID, const PlayerID &InPlayerID )
	{
 		Result hr;
	...
	// Cmd: Join
	Result NetPolicyGame::JoinChatChannelCmd( const TransactionID &InTransactionID, const uint64_t &InChatUID, const AccountID &InInviterID, const char* InPasscode )
	{
 		Result hr;
	...
	Result NetPolicyGame::ChatChannelChatMessageCmd( const TransactionID &InTransactionID, const uint64_t &InChatUID, const VariableTable &InChatMetaData, const char* InChatMessage )
	{
 		Result hr;
	...
	Result NetPolicyGame::WhisperMessageCmd( const TransactionID &InTransactionID, const PlayerID &InReceiverID, const char* InReceiverName, const VariableTable &InChatMetaData, const char* InChatMessage )
	{
 		Result hr;
	...
	Result NetPolicyGame::CreateCharacterCmd( const TransactionID &InTransactionID, const char* InCharacterName, const VariableTable &InPublicData, const VariableTable &InPrivateData )
	{
 		Result hr;
	...
	Result NetPolicyGame::DeleteCharacterCmd( const TransactionID &InTransactionID, const uint32_t &InCharacterID )
	{
 		Result hr;
	...
	Result NetPolicyGame::GetCharacterListCmd( const TransactionID &InTransactionID )
	{
 		Result hr;
	...
	// Cmd: 
	Result NetPolicyGame::GetCharacterDataCmd( const TransactionID &InTransactionID, const uint32_t &InCharacterID )
	{
 		Result hr;
	...
	Result NetPolicyGame::SelectCharacterCmd( const TransactionID &InTransactionID, const uint32_t &InCharacterID )
	{
 		Result hr;
	...
	Result NetPolicyGame::RequestServerNoticeUpdateCmd( const TransactionID &InTransactionID )
	{
 		Result hr;
	...
	Result NetPolicyGame::CallFunctionCmd( const TransactionID &InTransactionID, const StringCrc32 &InFunctionName, const VariableTable &InParameters )
	{
 		Result hr;
	...
	// Cmd: player complition statues
	Result NetSvrPolicyGame::GetAchievementStatsRes( const TransactionID &InTransactionID, const Result &InResult, const Array<AchievementStat>& InAchievementStats )
	{
 		Result hr;
	...
	// Cmd: Player complition state
	Result NetSvrPolicyGame::Dummy1Res( const TransactionID &InTransactionID, const Result &InResult )
	{
 		Result hr;
	...
	// Cmd: PlayerId Conversion
	Result NetSvrPolicyGame::FindPlayerByPlatformIdRes( const TransactionID &InTransactionID, const Result &InResult, const PlayerID &InPlayerId, const PlayerPlatformID &InPlayerPlatformId )
	{
 		Result hr;
	...
	// Cmd: PlayerId conversion
	Result NetSvrPolicyGame::FindPlayerByCharacterNameRes( const TransactionID &InTransactionID, const Result &InResult, const PlayerID &InPlayerId )
	{
 		Result hr;
	...
	// Cmd: PlayerId Conversion
	Result NetSvrPolicyGame::FindPlayerByPlatformUserNameRes( const TransactionID &InTransactionID, const Result &InResult, const PlayerID &InPlayerId, const PlayerPlatformID &InPlayerPlatformId )
	{
 		Result hr;
	...
	// Cmd: Game user game play information
	Result NetSvrPolicyGame::GetUserGamePlayerInfoRes( const TransactionID &InTransactionID, const Result &InResult, const VariableTable &InAttributes )
	{
 		Result hr;
	...
	// Cmd: Game game play information
	Result NetSvrPolicyGame::GetGamePlayerInfoRes( const TransactionID &InTransactionID, const Result &InResult, const AccountID &InPlayerID, const VariableTable &InAttributes )
	{
 		Result hr;
	...
	// Cmd: Join to a game instance
	Result NetSvrPolicyGame::JoinGameInstanceRes( const TransactionID &InTransactionID, const Result &InResult, const uint64_t &InInsUID, const char* InServerPublicAddress )
	{
 		Result hr;
	...
	// Cmd: Leave game instance
	Result NetSvrPolicyGame::LeaveGameInstanceRes( const TransactionID &InTransactionID, const Result &InResult )
	{
 		Result hr;
	...
	// Cmd: Search game instance
	Result NetSvrPolicyGame::SearchGameInstanceRes( const TransactionID &InTransactionID, const Result &InResult, const Array<VariableTable>& InGameInstances )
	{
 		Result hr;
	...
	// Cmd: Search game instance
	Result NetSvrPolicyGame::GetCharacterDataInGameInstanceRes( const TransactionID &InTransactionID, const Result &InResult, const PlayerID &InPlayerID, const VariableTable &InGameInstances )
	{
 		Result hr;
	...
	// Cmd: Create or Join Chat channel
	Result NetSvrPolicyGame::CreateOrJoinChatChannelRes( const TransactionID &InTransactionID, const Result &InResult, const uint64_t &InChatUID, const PlayerID &InChannelLeaderID )
	{
 		Result hr;
	...
	// Cmd: Join
	Result NetSvrPolicyGame::JoinChatChannelRes( const TransactionID &InTransactionID, const Result &InResult, const uint64_t &InChatUID, const PlayerID &InChannelLeaderID )
	{
 		Result hr;
	...
	// Cmd: Whisper(tell) other player chatting
	Result NetSvrPolicyGame::WhisperMessageRes( const TransactionID &InTransactionID, const Result &InResult )
	{
 		Result hr;
	...
	// Cmd: Create character
	Result NetSvrPolicyGame::CreateCharacterRes( const TransactionID &InTransactionID, const Result &InResult, const uint32_t &InCharacterID )
	{
 		Result hr;
	...
	// Cmd: Delete character
	Result NetSvrPolicyGame::DeleteCharacterRes( const TransactionID &InTransactionID, const Result &InResult )
	{
 		Result hr;
	...
	// Cmd: Get character list
	Result NetSvrPolicyGame::GetCharacterListRes( const TransactionID &InTransactionID, const Result &InResult, const Array<VariableTable>& InCharacters )
	{
 		Result hr;
	...
	// Cmd: 
	Result NetSvrPolicyGame::GetCharacterDataRes( const TransactionID &InTransactionID, const Result &InResult, const VariableTable &InPrivateData, const VariableTable &InEquipData )
	{
 		Result hr;
	...
	// Cmd: Select character
	Result NetSvrPolicyGame::SelectCharacterRes( const TransactionID &InTransactionID, const Result &InResult, const uint32_t &InCharacterID, const VariableTable &InAttributes )
	{
 		Result hr;
	...
	// Cmd: Request Server Notice. Sever will send ServerNoticeS2CEvt
	Result NetSvrPolicyGame::RequestServerNoticeUpdateRes( const TransactionID &InTransactionID, const Result &InResult )
	{
 		Result hr;
	...
	// Cmd: To call general functionality
	Result NetSvrPolicyGame::CallFunctionRes( const TransactionID &InTransactionID, const Result &InResult, const VariableTable &InResults )
	{
 		Result hr;
