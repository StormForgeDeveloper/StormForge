...
namespace SF
{
	...
	// Cmd: Login request with Facebook UID
	Result NetPolicyLogin::LoginBySteamCmd( const uint64_t &InTransactionID, const uint32_t &InGameID, const uint64_t &InSteamUserID, const char* InSteamUserToken )
	{
 		ScopeContext hr;
		 ...
		 pMessage = SF::Message::Login::LoginBySteamCmd::Create(GetSystemHeap(), InTransactionID, InGameID, InSteamUserID, InSteamUserToken);
		 protocolCheckPtr(*pMessage);
	...
	Result NetSvrPolicyLogin::LoginRes( const uint64_t &InTransactionID, const Result &InResult, const NetAddress &InGameServerAddr, const NetAddress &InGameServerAddrIPV4, const AccountID &InAccID, const AuthTicket &InTicket, const uint64_t &InLoginEntityUID )
	{
		 ...
		 pMessage = SF::Message::Login::LoginRes::Create(GetSystemHeap(), InTransactionID, InResult, InGameServerAddr, InGameServerAddrIPV4, InAccID, InTicket, InLoginEntityUID);
		 protocolCheckPtr(*pMessage);
	...
	Result NetSvrPolicyLogin::LoginByFacebookRes( const uint64_t &InTransactionID, const Result &InResult, const NetAddress &InGameServerAddr, const NetAddress &InGameServerAddrIPV4, const AccountID &InAccID, const AuthTicket &InTicket, const uint64_t &InLoginEntityUID )
	{
		 ...
		 pMessage = SF::Message::Login::LoginByFacebookRes::Create(GetSystemHeap(), InTransactionID, InResult, InGameServerAddr, InGameServerAddrIPV4, InAccID, InTicket, InLoginEntityUID);
		 protocolCheckPtr(*pMessage);
