...
namespace SF
{
 	namespace Message
	{
 		namespace Login
		{
			...
			class PreLoginRequestServerNoticeUpdateCmd : public MessageBase
			{
 			public:
				static const MessageID MID;
				// Parameter type informations for template
			...
			private:
				uint64_t m_TransactionID{};
			public:
				PreLoginRequestServerNoticeUpdateCmd()
					{}

				PreLoginRequestServerNoticeUpdateCmd( const MessageDataPtr &pMsg )
					: MessageBase(pMsg)
					{}
			...
			class PreLoginRequestServerNoticeUpdateRes : public MessageBase
			{
 			public:
				static const MessageID MID;
				// Parameter type informations for template
			...
			private:
				...
				Result m_Result{};
			public:
				PreLoginRequestServerNoticeUpdateRes()
					{}

				PreLoginRequestServerNoticeUpdateRes( const MessageDataPtr &pMsg )
					: MessageBase(pMsg)
					{}
			...
			class PreLoginServerNoticeS2CEvt : public MessageBase
			{
 			public:
				static const MessageID MID;
				// Parameter type informations for template
			...
			public:
				...
				PreLoginServerNoticeS2CEvt( const MessageDataPtr &pMsg )
					: MessageBase(pMsg)
					{}
