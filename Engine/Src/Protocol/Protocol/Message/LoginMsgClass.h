 	...
 	namespace Message
	{
 		namespace Login
		{
			...
			public:
				...
				static MessageData* Create( IHeap& memHeap, const uint32_t &InGameID, const char* InID, const char* InPassword );
			...
			public:
				...
				static MessageData* Create( IHeap& memHeap, const Result &InResult, const NetAddress &InGameServerAddr, const NetAddress &InGameServerAddrIPV4, const AccountID &InAccID, const AuthTicket &InTicket, const uint64_t &InLoginEntityUID );
			...
			public:
				...
				static MessageData* Create( IHeap& memHeap, const uint32_t &InGameID, const uint64_t &InUID, const char* InFaceBookName, const char* InEMail, const char* InFacebookToken );
			...
			public:
				...
				static MessageData* Create( IHeap& memHeap, const uint32_t &InGameID, const char* InCellPhone );
			...
			public:
				...
				static MessageData* Create( IHeap& memHeap, const uint64_t &InRankingScore, const RankingType &InRankingType, const uint16_t &InCount );
			...
			public:
				...
				static MessageData* Create( IHeap& memHeap, const RankingType &InRankingType, const uint8_t &InBaseRanking, const uint8_t &InCount );
			...
			public:
				...
				static MessageData* Create( IHeap& memHeap, const Array<uint8_t>& InTestData );
			...
			public:
				...
				static MessageData* Create( IHeap& memHeap, const Result &InResult, const Array<uint8_t>& InTestData );
			...
			public:
				...
				static MessageData* Create( IHeap& memHeap, const char* InFileName );
