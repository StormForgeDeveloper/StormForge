...
namespace TestNet.WinSharp
{
    public class StressTest_MatchingUser
    {
        ...
        System.Action<StressTest_MatchingUser> mSendReqLeaveGameAction = null;
        ...
        public void RunConnect(NetAddress serverAddress,
            ...
            System.Action<StressTest_MatchingUser> OnSendReqMatchAction,
            System.Action<StressTest_MatchingUser, bool> OnReqMatchResAction,


            System.Action<StressTest_MatchingUser> OnReqLeaveGameAction)
        {
            ...
            mSendReqMatchAction = OnSendReqMatchAction;
            mReqMatchResAction = OnReqMatchResAction;

            mSendReqLeaveGameAction = OnReqLeaveGameAction;
...
//          PrintStatus("HandleLeaveGameRes ID = {0}", m_LoginID);
        ...
        void HandlePlayerJoinedS2Evt(SFMessage message)
        {
            ...
            PrintStatus(0, "HandlePlayerJoinedS2Evt  GameInsID = {0} ID  = {1}", GameInsID, m_LoginID);
            ...
            m_MatchedInfo.mOtherPlayers.Add(JoinedPlayer);
        }
