...
sudo apt-get install -y moreutils git-lfs build-essential clang rsync zip ninja-build libatomic-ops-dev gdb perl pkg-config openjdk-17-jdk dotnet8 cmake linux-libc-dev
