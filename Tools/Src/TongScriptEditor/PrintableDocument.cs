    ...
    public class PrintableDocument : DomNodeAdapter, IPrintableDocument
    {
        ...
        public PrintDocument GetPrintDocument()
        {
            ...
            s_printDocument.SetDocument(
                DomNode.Cast<SF.Tong.Editor.TongScriptEditingContext>(),
        ...
        {
            public void SetDocument(SF.Tong.Editor.TongScriptEditingContext editingContext, ViewingContext viewingContext)
            {
            ...
            private TongScriptEditingContext m_editingContext;
