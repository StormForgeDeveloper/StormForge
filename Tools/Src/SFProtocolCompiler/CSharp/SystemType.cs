...
namespace SF
{
    ...
    public class SystemTypeInfo
    {
        ...
        static TypeMap[] TypesMapList = new TypeMap[]{
            new TypeMap( ParameterType.String, -1, typeof(String), "const char*" ),
            ...
            new TypeMap( ParameterType.intptr, 8, typeof(IntPtr), "intptr_t" ),
            ...
            new TypeMap( ParameterType.TransactionID, 8, typeof(UInt64), "uint64_t" ),
            ...
            new TypeMap( ParameterType.GameInsUID, 8, typeof(UInt64), "uint64_t" ),
            new TypeMap( ParameterType.EntityID, 4, typeof(UInt32) ),
            new TypeMap( ParameterType.EntityUID, 8, typeof(UInt64), "uint64_t" ),
            new TypeMap( ParameterType.PartyUID, 8, typeof(UInt64), "uint64_t" ),
            ...
            new TypeMap( ParameterType.PlayerRole, 1, typeof(PlayerRole), "uint8_t" ),
            new TypeMap( ParameterType.GameStateID, 1, typeof(GameStateID), "uint8_t" ),
            new TypeMap( ParameterType.GameWinner, 1, typeof(GameWinner), "uint8_t" ),
            new TypeMap( ParameterType.PlayerKilledReason, 1, typeof(PlayerKilledReason), "uint8_t" ),
            new TypeMap( ParameterType.PlayerRevealedReason, 1, typeof(PlayerRevealedReason), "uint8_t" ),

            new TypeMap( ParameterType.GameID, 4, typeof(UInt32), "uint32_t" ),
            ...
            new TypeMap( ParameterType.LocalUID, 8, typeof(LocalUID), "uint64_t" ),
