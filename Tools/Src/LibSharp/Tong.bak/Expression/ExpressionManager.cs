...
// Author : KyungKun Ko
//
// Description : Tong script expression manager
//
////////////////////////////////////////////////////////////////////////////////
...
namespace SF.Tong
{
    ...
    /// </summary>
    public class ExpressionManager : DomNodeAdapter
    {
        protected override void OnNodeSet()
        {
            if (!tongScriptType.Type.IsAssignableFrom(DomNode.Type))
            ...
            Expressions = GetChildList<Expression>(tongScriptType.expressionChild);
        ...
        {
            get { return DomNode.GetChildList(tongScriptType.moduleChild); }
        }
        ...
        public void SetPythonScriptService(ScriptingService scriptService)
        {
            ...
            m_pythonService = (Sce.Atf.Applications.BasicPythonService)scriptService;
        }
        ...
        private Sce.Atf.Applications.BasicPythonService m_pythonService;
    }
}
